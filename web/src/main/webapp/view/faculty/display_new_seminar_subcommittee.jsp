...
<% SeminarSubCommittee seminarSubCommittee = (SeminarSubCommittee) request.getAttribute("seminarSubCommittee");%>
    ...
    <div id="content">
      ...
      <div class="row">
        <div class="span12 offset4">
        	<div class="alert alert-success" style="width:550px">Tạo mới một tiểu ban thành công </div>
