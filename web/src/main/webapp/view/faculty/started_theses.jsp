    ...
    <div id="content">
        <div class="container">
            <div class="center hero-content">
                <h1>Danh sách đề tài đợi phân giảng viên phản biện</h1>
                <form method="post" action="/faculty/startedtheses/list">
                    <div>
                        <input type="text" name="keyword" size="40" class="postgraduate-keyword"
                               value="<%=(request.getParameter("keyword") == null) ? "" : request.getParameter("keyword")%>"/>

                        <select id="chon_khoa" name="year" class="postgraduate-select">
                    ...
                    <table class="postgraduate-table-result table table-bordered" id="postgraduate_list">
                        ...
                        <tr>
                            ...
                            <td><%= (p.getThesis().getComment() == null || p.getThesis().getComment().equals("")) ?
                                    ...
                                    p.getThesis().getComment() %></td>
                            <td>

                                <a href="/faculty/thesis/detail?pid=<%=p.getId()%>">Phân giảng viên</a>
