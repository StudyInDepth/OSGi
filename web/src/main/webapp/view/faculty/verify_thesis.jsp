    ...
    <div id="content">
        <div class="container">
            <div class="center hero-content">
                <h1>Danh sách đề tài đợi duyệt đề cương</h1>
                <form method="post" action="/faculty/thesis/verify">
                    <div>
                ...
                <form action="/faculty/thesis/verify" method="post">
                    <table class="postgraduate-table-result table table-bordered" id="postgraduate_list">
                        ...
                        <tr>
                           ...
                           <td><input type="checkbox" id="check_<%=p.getThesis().getId()%>"name="thesis_ids" value="<%=p.getThesis().getId()%>"/></td>
                        </tr>
                        <% } %>
                    </table>
                    <input type="hidden" name="year" value="<%=request.getParameter("year")%>"/>
                    <input type="hidden" name="keyword" value="<%=request.getParameter("keyword")%>"/>
                    <input type="submit" value="Duyệt đề cương" class="btn btn-large btn-primary"/>
                </form>
            <% } %>
            </div>
        </div>
