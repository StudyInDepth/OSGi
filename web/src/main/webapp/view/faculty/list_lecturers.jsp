    ...
    <div id="content">
        <div class="container">
            <div class="center hero-content">
                <% Object lecturerBOError = request.getAttribute("lecturerBOError");%>
                <% if (lecturerBOError != null) {%>
                        <div class="alert alert-warning">
                            Dịch vụ từ Lectuer Services chưa sẵn sàng để sử dụng!
                        </div>
                <%} else {%>
                <h1>Danh sách giảng viên</h1>

                <form method="get" action="/faculty/lecturer/list">
                    <div>
                        <input placeholder="Họ tên/Học vị" type="text" name="keyword" class="lecturer-keyword"
                               size="40"
                               value=
