...
public class PostgraduateListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher dispatcher = httpServletRequest.getRequestDispatcher("/view/faculty/list_postgraduates.jsp");
            dispatcher.forward(httpServletRequest, httpServletResponse);
        } catch (Exception e) {
           // e.printStackTrace();
            httpServletRequest.setAttribute("postgraduateBOError", true);
            RequestDispatcher dispatcher = httpServletRequest.getRequestDispatcher("/view/faculty/list_postgraduates.jsp");
            dispatcher.forward(httpServletRequest, httpServletResponse);
         }
    }
