...
<head>
    ...
    <script>
        function getLectureDetail(id) {
            $.post("/postgraduate/lecturer/detail",
                    {
                        id: id
                    },
                    function (data, status) {
                        if (data == "false") {
                            ...
                            if(id != "false") {
                                location.href = "/postgraduate/lecturer/detail?id=" + id;
                            }
                        }
                    });
        }
        function getPostgraduateDetail(id) {
            location.href = "/postgraduate/postgraduate/detail?id=" + id;
        }
    </script>
    ...
    <div id="content">
        <div class="container">
            <div class="center hero-content">
                ...
                <form method="post" action="/postgraduate/postgraduate/list">
                    <div>
