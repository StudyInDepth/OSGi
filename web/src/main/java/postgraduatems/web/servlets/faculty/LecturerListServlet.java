...
public class LecturerListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException, IOException {
        try {
            ...
            RequestDispatcher dispatcher = httpServletRequest.getRequestDispatcher("/view/faculty/list_lecturers.jsp");
            dispatcher.forward(httpServletRequest, httpServletResponse);

        } catch (Exception e) {


            httpServletRequest.setAttribute("lecturerBOError", true);
            RequestDispatcher dispatcher = httpServletRequest.getRequestDispatcher("/view/faculty/list_lecturers.jsp");
            dispatcher.forward(httpServletRequest, httpServletResponse);
